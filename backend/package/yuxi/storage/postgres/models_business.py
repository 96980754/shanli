...
class KnowledgeHandoff(Base):
    ...
    domain = Column(String(64), nullable=True, comment="业务域，决定转接哪个企微客服")
    refusal_type = Column(String(32), nullable=True, comment="拒答类型：knowledge_refusal/scope_refusal/policy_refusal")
    refusal_reason = Column(String(64), nullable=True, comment="拒答原因，见 knowledge_answer_disposition")
