  ...
  <aside class="workspace-sidebar">
    <section class="sidebar-section">
      ...
      >
        ...
        <span>{{ $t('workspace.personalWorkspace') }}</span>
      </button>
    </section>

    <section class="sidebar-section">
      <div class="section-title">{{ $t('workspace.quickAccess') }}</div>
      <button
        type="button"
    ...
    <section v-if="myDatabases.length" class="sidebar-section">
      <div class="section-title">{{ $t('workspace.myKnowledgeBases') }}</div>
      <button
    ...
    <section v-if="sharedDatabases.length" class="sidebar-section">
      <div class="section-title">{{ $t('workspace.sharedKnowledgeBases') }}</div>
      <button
    ...
    <section v-if="loadingDatabases" class="sidebar-section">
      <div class="sidebar-muted">{{ $t('workspace.loadingKnowledgeBases') }}</div>
    </section>
    <section v-else-if="!databases.length" class="sidebar-section">
      <div class="sidebar-muted">{{ $t('workspace.noAccessibleKnowledgeBases') }}</div>
    </section>
  </aside>
</template>
